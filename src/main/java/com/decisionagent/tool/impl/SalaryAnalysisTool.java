 ...
 *
 * Analyzes the user's income situation, including current salary, market comparison,
 * and potential salary growth from job switching.
 *
...
public class SalaryAnalysisTool implements AnalysisTool {
    ...
    public String analyze(UserProfile profile, String userMessage) {
        log.info("Analyzing salary dimension for profile: {}", profile);
